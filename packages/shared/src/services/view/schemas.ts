...
import { taskStatusSchema } from '@services/services/task/schemas'
...
export const createViewSchema = z
  .object({
    ...
    name: z
      .string()
      .trim()
      .min(1, 'Il nome della vista Ã¨ obbligatorio')
      .max(80, 'Il nome della vista puÃ² contenere al massimo 80 caratteri'),
