...
export const KanbanColumn = ({
  ...
  const idleBorder = `${token.lineWidth}px solid ${token.colorPrimaryBorder}`
  const baseBackground = token.colorPrimaryBg
  ...
  return (
    <Card
      ...
      style={{
        ...
        background: isDragOver ? token.colorPrimaryBgHover : baseBackground,
